...
%% Describe GPS landing first and then describe how it is a stepping stone to automatic charging.
...
Table \ref{tbl:visible-height} shows the visible landing area corresponding to the 
...
\begin {table}[h!]
  ...
  \end{tabular}}
   ...
   \label{tbl:visible-height}
\end {table}

We could make the landing pad smaller or use a concentric landing pattern to mitigate this issue.
