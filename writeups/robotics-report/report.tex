...
The automated landing problem has been solved in the research literature of the
early 2000s. Here we briefly describe the approaches taken by some of the most
cited papers on this topic.

Sharp, Shakernia, and Sastry \ref{sharp_et_al_2001} designed an approach for
automatically landing an unmanned helicopter. Their landing target uses a
simple two-color design made up of several squares. Onboard the helicopter,
...
Saripalli, Montgomery, and Sukhatme \ref{saripalli_et_al_2002} designed another
approach for automatically landing an unmanned helicopter. They use a two-color
H-shaped landing target.
